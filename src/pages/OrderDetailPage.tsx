...
import { Package, Clock, Truck, CheckCircle, XCircle, Loader2, ArrowLeft, MapPin, CreditCard, FileText } from 'lucide-react';
      ...
      <div className="container py-6">
        ...
        <div className="bg-white rounded-xl border border-[var(--color-border)] overflow-hidden shadow-[var(--shadow-sm)] mb-6">
          <div className="p-4 border-b border-[var(--color-border)] bg-[var(--color-surface)]">
            <h2 className="font-serif">Order Items ({order.items?.length || 0})</h2>
          </div>
