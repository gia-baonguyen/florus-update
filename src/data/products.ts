...
export const products: Product[] = [
  {
    ...
    aiScore: 95,
    description: '20% Vitamin C serum for brighter, more even skin tone',
    ingredients: ['Vitamin C 20%', 'Ferulic Acid', 'Vitamin E'],
    tags: ['Brightening', 'Antioxidant', 'Dark Spot Fading'],
  },
  {
    id: '2',
    ...
    aiScore: 92,
    description: 'Moisturizing cream with Hyaluronic Acid for 24h hydration',
    ingredients: ['Hyaluronic Acid', 'Ceramide', 'Niacinamide'],
    tags: ['Hydrating', 'Restorative', 'Non-greasy'],
  },
  {
    id: '3',
    ...
    aiScore: 88,
    description: 'Smooth matte lipstick, 12-hour color retention',
    tags: ['Long-lasting', 'Smooth finish', 'Non-drying'],
  },
  {
    id: '4',
    ...
    aiScore: 96,
    description: 'Retinol eye cream to reduce dark circles and wrinkles',
    ingredients: ['Retinol 0.5%', 'Peptides', 'Caffeine'],
    tags: ['Anti-aging', 'Dark circle reduction', 'Firming'],
  },
  {
    id: '5',
    ...
    aiScore: 87,
    description: 'Perfect coverage foundation, natural finish with SPF 30',
    tags: ['Full coverage', 'SPF 30', 'Natural finish'],
  },
  {
    id: '6',
    ...
    aiRecommendType: 'cold-start',
    aiScore: 90,
    description: 'Gentle foam cleanser, deep cleansing without drying',
    ingredients: ['Amino Acids', 'Glycerin', 'Aloe Vera'],
    tags: ['Gentle', 'Deep cleansing', 'pH balanced'],
  },
  {
    id: '7',
    ...
    aiRecommendType: 'collaborative',
    aiScore: 85,
    description: 'Volume mascara with natural curl enhancement',
    tags: ['Volume boost', 'Natural curl', 'Smudge-proof'],
  },
  {
    id: '8',
    ...
    aiRecommendType: 'content-based',
    aiScore: 89,
    description: 'Baked blush for natural, radiant glow',
    tags: ['Natural', 'Long-lasting', 'Easy to blend'],
  },
  {
    id: '9',
    ...
    aiRecommendType: 'warm-start',
    aiScore: 93,
    description: 'Elegant rose fragrance perfume, 8-hour lasting scent',
    tags: ['Luxurious', 'Long-lasting scent', 'Captivating'],
  },
  {
    id: '10',
    ...
    aiRecommendType: 'cross-sell',
    aiScore: 91,
    description: 'Mineral sunscreen SPF 50+ PA++++, no white cast',
    ingredients: ['Zinc Oxide', 'Titanium Dioxide', 'Niacinamide'],
    tags: ['SPF 50+', 'No white cast', 'Non-comedogenic'],
  },
  {
    id: '11',
    ...
    aiRecommendType: 'content-based',
    aiScore: 86,
    description: 'Clay detox mask, minimizes pores',
    ingredients: ['Kaolin Clay', 'Charcoal', 'Tea Tree Oil'],
    tags: ['Detoxifying', 'Pore minimizing', 'Oil control'],
  },
  {
    id: '12',
    ...
    aiRecommendType: 'collaborative',
    aiScore: 84,
    description: 'Gel nail polish, glossy and long-lasting',
    tags: ['Glossy', 'Long-lasting', 'Easy application'],
  },
  {
    id: '13',
    ...
    aiRecommendType: 'warm-start',
    aiScore: 94,
    description: '12-shade nude eyeshadow palette, easy to blend',
    tags: ['Versatile', 'Blendable', 'Long-wearing'],
  },
];
